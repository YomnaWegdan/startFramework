...
export default function Portfolio() {
  const [image, setImage] = useState([img1, img2, img3 , img1 , img2 , img3]);
        ...
        <div className="container h-100">
          <div className="row g-5 h-100 align-items-center justify-content-center align-content-center">
            <div className="col-md-12">
              ...
              {image.map((img, index) => (
                <div className="img col-lg-4 col-md-6 "  key={index}>
                  ...
                  <img
                    ...
                    alt="lol"
                  />
                  <div className="img-overlay rounded-3 d-flex justify-content-center align-items-center position-absolute" onClick={()=>toggleModel(index)}>
                    <FaPlus className="plus  fw-bold text-white"/>
                  </div>
                  </div>
                </div>
                ) )}
                ...
                {model ? (
                  <div onClick={()=>toggleModel(null)} className="model position-fixed top-0 left-0 w-100 h-100 overflow-hidden  d-flex align-items-center justify-content-center">
