          ...
          <div className="row g-5 h-100 align-items-center justify-content-center align-content-center">
            ...
            <div className=" col-md-12">
              ...
              <input
                ...
                />
                <label className=" d-none position-absolute start-0 " htmlFor="yourInput">userName</label>
                </div>
                ...
                <input
                  ...
                  onChange={handleFocus}
                />
                <label className=" d-none position-absolute start-0 " htmlFor="yourInput">userAge</label>
                ...
                <input
                  ...
                  onChange={handleFocus}
                />
                <label className=" d-none position-absolute start-0 " htmlFor="yourInput">userEmail</label>
                ...
                <input
                  ...
                  onChange={handleFocus}
                />
                <label className=" d-none position-absolute start-0 " htmlFor="yourInput">userPassword</label>
                </div>
