    ...
    <section className='portfolio vh-100 '>
        <div className='container h-100'>
            <div className='row h-100 align-items-center justify-content-center align-content-center'>
                ...
                {model===false? image.map((img , index)=>
                    <div className='col-lg-4 col-md-6' key={index}>  
                        <img src={img} className='w-100' alt='lol' onClick={setModel} />             
                    </div>
                    ): <div className='position-fixed top-0 left-0 w-100 h-100 overflow-hidden bg-dark d-flex align-items-center justify-content-center'>
                            <div className='w-50 h-50 '><img src={img1} className='w-100' alt='lol'/></div>
                    </div>}
                </div>
        </div>
    </section>
